...
exports.adminUpdateStudent = AysncHandler(async (req, res) => {
  ...
  const studentUpdated = await Student.findByIdAndUpdate(
    ...
    {
      //The $set operator is used to update the value of specific fields in a document. If the field already exists, its value will be replaced with the new value provided. If the field does not exist, it will be added to the document with the specified value.
      $set: {
        name,
        email,
        academicYear,
      ...
      //The $addToSet operator is used to add elements to an array only if they do not already exist in the array. It prevents duplicate entries from being added to the array.
      $addToSet: {
        classLevels,
      },
    },
